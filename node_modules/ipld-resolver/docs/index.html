<!doctype html>
<html><head><meta charset="utf-8"/><meta name="viewport" content="width=device-width, initial-scale=1.0"/><title>ipld-resolver - Documentation</title><link href="https://fonts.googleapis.com/css?family=Roboto+Mono:400,500|Roboto:300,500,700" rel="stylesheet"/><style>body{margin: 0;
padding: 0;
color: #000;
...
font-weight: bold;}.hljs-deletion{background: #fdd;}.hljs-addition{background: #dfd;}.hljs-emphasis{font-style: italic;}.hljs-strong{font-weight: bold;}</style><div style="margin-bottom:104px;" data-radium="true"><h1 data-radium="true"><a class="anchor" name="intro"></a>Intro</h1><div><p>Installable via  <code>npm install --save ipld-resolver</code>, it can also be used directly in the browser.</p>
<h2>Download</h2>
<p>The source is available for download from <a href="git+https://github.com/ipld/js-ipld-resolver.git">GitHub</a>. Alternatively, you can install using npm:</p>
<pre class='hljs'>$ npm install --save ipld-resolver</pre>
<p>You can then <code>require()</code> ipld-resolver as normal:</p>
<pre class='hljs'><span class="hljs-keyword">const</span> ipldResolver = <span class="hljs-built_in">require</span>(<span class="hljs-string">'ipld-resolver'</span>)</pre>
<h2>In the Browser</h2>
<p>Ipld-resolver should work in any ES2015 environment out of the box.</p>
<p>Usage:</p>
...
<p>The portable versions of ipld-resolver, including <code>index.js</code> and <code>index.min.js</code>, are included in the <code>/dist</code> folder. Ipld-resolver can also be found on <a href="https://unpkg.com">unkpkg.com</a> under</p>
<ul>
<li><a href="https://unpkg.com/ipld-resolver/dist/index.min.js">https://unpkg.com/ipld-resolver/dist/index.min.js</a></li>
<li><a href="https://unpkg.com/ipld-resolver/dist/index.js">https://unpkg.com/ipld-resolver/dist/index.js</a></li>
</ul>
</div></div><div style="margin-bottom:104px;" data-radium="true"><h1 data-radium="true"><a class="anchor" name="inmemory"></a>inMemory<a href="https://github.com/ipld/js-ipld-resolver/blob/8bfec1d088be0d2901fbafe9210946c353e57221/src/index.js#L402-L422" title="src/index.js" style="float:right;" data-radium="true"><svg fill="currentColor" preserveAspectRatio="xMidYMid meet" height="1em" width="1em" viewBox="0 0 40 40" style="vertical-align:middle;"><g><path d="m26.3 7.5l-3.8 3.8 8.8 8.7-8.8 8.8 3.8 3.7 11.2-12.5-11.2-12.5z m-12.5 0l-11.3 12.5 11.3 12.5 3.7-3.7-8.7-8.8 8.7-8.7-3.7-3.8z"></path></g></svg></a></h1><div><p>Create an IPLD resolver with an inmemory blockservice and
repo.</p>
</div><div data-radium="true"><h4>Parameters</h4><ol style="list-style:none;margin-left:0;padding-left:0;" data-radium="true"><div data-radium="true"><li style="padding-bottom:13px;" data-radium="true"><code>callback: function (<a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Error">Error</a>, IPLDResolver)</code>:  <div style="display:inline-block;" data-radium="true"></div></li></div></ol></div><div data-radium="true"><h4>Returns</h4><div data-radium="true"><code>void</code><span> 
